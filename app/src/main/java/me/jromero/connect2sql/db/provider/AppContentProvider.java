package me.jromero.connect2sql.db.provider;
...
import me.jromero.connect2sql.di.DaggerContentProviderComponent;
...
import me.jromero.connect2sql.log.Log;

public class AppContentProvider extends ContentProvider {

    private static final String TAG = AppContentProvider.class.getSimpleName();

    public static final String AUTHORITY = "me.jromero.connect2sql.db.provider.AppContentProvider";
    private static final String VND_PATH = "vnd.me.jromero.connect2sql.db";
