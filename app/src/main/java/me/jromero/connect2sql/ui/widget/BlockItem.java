...
public class BlockItem extends FrameLayout {
    ...
    private void readAttributes(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs,
                R.styleable.me_jromero_connect2sql_ui_widget_BlockItem);

        // get/set title
        setTitle(ta.getString(R.styleable.me_jromero_connect2sql_ui_widget_BlockItem_title));

        // get/set subtitle
        setSubtitle(ta.getString(R.styleable.me_jromero_connect2sql_ui_widget_BlockItem_subtitle));

        // get/set image resource
        setImageResource(ta.getResourceId(R.styleable.me_jromero_connect2sql_ui_widget_BlockItem_image,
                DEFAULT_IMAGE));
