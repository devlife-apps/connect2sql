...
data class BasicAuth(private val username_: String, val password: String?) :
    Authentication(username_)

data class PrivateKey(private val username_: String,
                      val passphrase: String?,
                      val privateKeyContents: String) : Authentication(username_)